...
Public Sub DoWriteUriageNippo(ByVal wbSrc As Workbook)
    Dim wsSrc As Worksheet, wsWrite As Worksheet

    If Not ResolveSrcAndDst(wbSrc, URIAGE_NIPPO_UID, SHEET_URIAGE_NIPPO, wsSrc, wsWrite) Then Exit Sub
    ...
    With wsSrc
        ...
        valShakoPay = .Cells(r, "H").Value   ' 社交日払い
        valDanshiPay = .Cells(r, "I").Value  ' 男子日払い
    End With
